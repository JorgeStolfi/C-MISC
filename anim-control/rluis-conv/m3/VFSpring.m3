...
PROCEDURE Init(cf: T; a, b, c, d: CARDINAL; a1, a2, a3, k: LONGREAL) =
BEGIN
  cf.a  := a;  cf.b  := b;  cf.c := c;  cf.d := d;
  cf.a1 := a1; cf.a2 := a2; cf.a3 := a3;
  cf.k  := k;
END Init;

PROCEDURE Compute(cf: T; pos, vel, f: Vector; <*UNUSED*> t: LONGREAL) =
...
BEGIN
  WITH
    ...
    q  = LR3.Sub(pd, LR3.Mix(a1, pa, 1.0D0, LR3.Mix(a2, pb, a3, pc))),
    fx = cf.k*q[0],
    fy = cf.k*q[1],
    fz = cf.k*q[2]
  DO
