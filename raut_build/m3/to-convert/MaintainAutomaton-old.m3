...
MODULE MaintainAutomaton EXPORTS Main;          (* Version 2.2 *)

(*
  This program performs maintance operations on wordlist automata.
  ...
  Any of those operations may be combined with any subset of the following:
  ...
  Other commands and options are:
    ...
    -dagSize <num>      
        ...
        automatcally needed as needed, anyway; so this optimization
  ...
  For compatibilty with previous versions, "-dumpIn" and "-dumpOut"
  may be used instead of "-load" and "-dump".  Aso, all keywords may also
  be given entirely in lower case.
  ...
  BEGIN
    ...
    DO
      TRY
        ...
        IF Empty(arg.dump) THEN
          arg.dump := ParamUtil.GetFileName(pp, cmdWr, "-dumpOut");
        END;
