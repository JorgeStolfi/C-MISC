/* Last edited on 2007-08-16 00:05:56 by stolfi */
...
void ParseFreeVector(byte *L, long N, double *v, long M, long R);
  /*
...
void ParseFixedVector(byte *L, long N, long W, double *v, long M, long R);
  /*
